...
DisplayResults <- function(multi.2cls.switch, repeated) {
  ...
  oml <- switch(
    multi.2cls.switch, 
    "multi" = "6-additions/openml-benchmark/openml-benchmark-multi-cls-repeated.RDS", 
    "2cls"  = "6-additions/openml-benchmark/openml-benchmark-2-cls-repeated.RDS") %>% 
    readRDS()
...
DisplayResults(multi.2cls.switch = "2cls", repeated = FALSE) # Fig 18 (main)
DisplayResults(multi.2cls.switch = "2cls", repeated = TRUE) # Fig 19 (main)
DisplayResults(multi.2cls.switch = "multi", repeated = FALSE) # Fig 20 (main)
DisplayResults(multi.2cls.switch = "multi", repeated = TRUE) # Fig 21 (main)
