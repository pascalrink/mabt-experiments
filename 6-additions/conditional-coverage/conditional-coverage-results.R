...
results_list <- readRDS("6-additions/conditional-coverage/ccs-results.RDS")
...
boxpl <- ggplot(
  ...
  scale_pattern_manual(values = c("NCV" = "none",
                                  ...
                                  "BBC-CV" = "stripe")) +
  scale_y_continuous(
    breaks = c(0.87, 0.89, 0.91, 0.93, 0.95,  0.97), minor_breaks = seq(0, 1, 0.01)) +
...
.myggsave("6-additions/conditional-coverage/ccs-results-boxplot.png", boxpl)
