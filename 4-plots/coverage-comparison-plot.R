...
# PREVIOUS VERSION FROM FIRST SUBMISSION ----
# 
# # This script generates Figure 5 in the main document
# 
# rm(list = ls())
...
# df$fill_color <- recode(df$fill_color, 
#                         "BT" = "1", "CP" = "3", "DeLong" = "3", "HM" = "3", 
#                         "MABT" = "2", "Wald" = "3", "Wilson" = "3")
# 
# my_colors <- RColorBrewer::brewer.pal(3, "Pastel1")
# 
# coverage_df <- aggregate(
...
# 
# ggplot(coverage_df, aes(x = method, y = covers, fill = fill_color, pattern = fill_color)) +
#   geom_boxplot_pattern(pattern_fill = "black", 
#     pattern_angle = 45, pattern_density = 0.1, 
#     pattern_spacing = 0.02, pattern_key_scale_factor = 0.1) +
#   theme_minimal() +
#   scale_fill_manual(values = my_colors) + 
#   scale_pattern_manual(values = c("3" = "none", 
#                                   "2" = "circle", 
#                                   "1" = "stripe")) + 
